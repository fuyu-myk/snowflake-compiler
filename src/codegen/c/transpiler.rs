...
impl <'a> CTranspiler<'a> {
    ...
    fn transpile_if_expression(&mut self, ast: &Ast, expr: &&Expression, if_expr: &IfExpression) -> (Option<Vec<CStatement>>, CExpr) {
        todo!()
    }
    ...
    fn transpile_fx_decl(&mut self, ast: &Ast, function: &FxDeclaration) -> CItem {
